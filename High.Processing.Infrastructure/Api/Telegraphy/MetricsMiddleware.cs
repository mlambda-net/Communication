...
public class MetricsMiddleware(RequestDelegate next)
{
    ...
    private static readonly Counter FailedRequests = Metrics.CreateCounter("http_requests_failed", "HTTP Requests Failed");
    private static readonly Histogram RequestDuration = Metrics.CreateHistogram("http_requests_duration", "HTTP Requests Duration");
